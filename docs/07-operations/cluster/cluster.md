...
We have explained earlier [how the Deployments are sent to a Cluster](../../02-concept/02-projects-workflows/deployment#deploy-to-cluster).
...
As explained [here](../../02-concept/02-projects-workflows/deployment#deploy-to-file) a Deployment can be written to a file. To install this Deployment on the Cluster you can select `Upload Deployments` **(1)**:
