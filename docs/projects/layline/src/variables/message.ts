import Message from "@site/layline/src/classes/Message";

/**
 * ## What
 * message is an instance of the {@link Message} class.
 ...
 *
 * ## How to use
 * Please check the {@link Message} documentation for more information.
 *
 */
