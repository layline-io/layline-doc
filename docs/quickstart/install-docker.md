...
![efb40761.png](.install-docker_images/efb40761.png "Log in to Configuration Center (Quickstart)")

The default credentials are `admin` / `admin`. After logging in you should see the Configuration Center dashboard:

![9641e48f.png](.install-docker_images/9641e48f.png "Configuration Center dashboard (Quickstart)")
...
![1ec349e3.png](.install-docker_images/1ec349e3.png "Open a sample Project (Quickstart)")
...
- [**Multi-Node Cluster Setup**](../concept/advanced/multi-node-cluster-setup.md) — Deploy with MySQL persistence and reactive clustering
