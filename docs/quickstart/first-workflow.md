...
![Created Project](.first-workflow_images/image.png)
...
![TransactionFormat Asset](.first-workflow_images/image-1.png)
...
4. Go to the section **Folders** and do the following:
   ...
   - In field **Input Directory** enter your input folder (e.g. `/tmp/layline/in`). Create the folder you entered if it does not exist.\
     ![image.png](.first-workflow_images/image-5.png)
...
1. Go to the section **Folders** and do the following:
   ...
   - In field **Temporary Directory** enter a temporary output folder (e.g. `/tmp/layline/out/type-a/tmp`). \
     \
     ![image.png](.first-workflow_images/image-6.png)
...
![File Input](.first-workflow_images/image-7.png)
...
![Mapping](.first-workflow_images/image-12.png)
...
\
![Router](.first-workflow_images/image-13.png)
...
![image.png](.first-workflow_images/image-14.png)
...
![Add JavaScript Processor](.first-workflow_images/image-15.png)
...
![image.png](.first-workflow_images/image-16.png)
...
![image.png](.first-workflow_images/image-9.png)
...
3. In the **Cluster** tab, select **Controller ->Deployment Storage. YIf this is your first deployment, you should see this:![image.png](.first-workflow_images/image-10.png)
...
1. Now check the **Engine State** of the Deployment by navigating to the **Engine State** tab. You should see all deployed elements as green:\
   ![image.png](.first-workflow_images/image-11.png)
...
1. Navigate to the  **Operations -->  Audit Trail --> Workflow Instances** tab. You should see our running workflow instance:
    ...
    ![image.png](.first-workflow_images/image-19.png)
...
1. Check the **Streams Audit Trail**. If all went well, it should show that the file has been processed.
   ...
   ![image.png](.first-workflow_images/image-20.png)

   When you select the entry you should see the detailed logs for this on the right panel:

   ![image.png](.first-workflow_images/image-21.png)
...
![image.png](.first-workflow_images/image-22.png)
...
![image.png](.first-workflow_images/image-23.png)
