...
4. **Dive into the reference** — Browse the [Asset Reference](../assets/index.mdx) to see all available sources, processors, and sinks. Check the [Language Reference](../language-reference/index.mdx) for JavaScript and Python scripting APIs.
