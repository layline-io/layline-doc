...
4. **Dive into the reference** — Browse the [Asset Reference](../assets/index.md) to see all available sources, processors, and sinks. Check the [Language Reference](../language-reference/index.md) for JavaScript and Python scripting APIs.
