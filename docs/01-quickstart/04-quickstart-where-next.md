...
4. **Dive into the reference** — Browse the [Asset Reference](/docs/assets) to see all available sources, processors, and sinks. Check the [Language Reference](/docs/language-reference) for JavaScript and Python scripting APIs.
