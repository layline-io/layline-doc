...
|----------|-------------|
| **Workflows** | Active workflows with instance counts across the cluster |
| **Connections** | Connection assets and their health status |
| **Services** | Running services (Timer, HTTP, JDBC, etc.) |
| **Sources** | Input sources (File, Kafka, HTTP, etc.) |
| **Sinks** | Output sinks (File, Kafka, S3, etc.) |
| **Formats** | Format parsers and their state |
| **Resources** | Resources (Data Dictionaries, Directories, etc.) |
| **Extensions** | Extensions (Prometheus, AWS, etc.) |
...
- [**Workflow State**](./workflow) — Detailed workflow monitoring
- [**Service State**](./services) — Service-specific documentation
