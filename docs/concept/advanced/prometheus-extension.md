...
![Extension Asset Viewer](./.prometheus-extension_images/Screenshot19-04-2024ExtensionAssetEntry.png "Extension Asset Viewer")

Add a _**Prometheus Extension**_ by clicking on the available _**Add new Asset**_ option.

![Create Extension](./.prometheus-extension_images/Screenshot19-04-2024ExtensionAdding.png "Create Extension")
...
![Add Metric Mapping](./.prometheus-extension_images/Screenshot19-04-2024AddMetricMapping.png "Add Metric Mapping")
...
![Add Metric Labels](./.prometheus-extension_images/Screenshot19-04-2024MetricLabels.png "Add Metric Labels")
...
![Extension Include via Project](./.prometheus-extension_images/Screenshot19-04-2024ExtensionIncludeProject.png "Extension Include via Project")
...
![Extension Include via Deployments Engine Configuration](./.prometheus-extension_images/Screenshot19-04-2024ExtensionIncludeEngineConfig.png "Extension Include via Deployments Engine Configuration")

Choosing this option allows to decide per Engine Configuration whether metrics exports should be performed.

More Details on Workflow Deployment can be found [here](../projects-workflows/deployment.md).
...
![layline.io Metrics screenshot](./.prometheus-extension_images/Screenshot19-04-2024Metrics.png "layline.io Metrics screenshot")
...
![Prometheus for layline.io](./.prometheus-extension_images/Screenshot19-04-2024Prometheus.png "Prometheus for layline.io")

At this stage you can enter your layline.io Prometheus Data Source to your Grafana instance:

![Grafana for layline.io](./.prometheus-extension_images/Screenshot19-04-2024Grafana.png "Grafana for layline.io")
