...
![Supervised machine learning train and test](./.artificial-intelligence_images/1705920719983.png "Supervised machine learning train and test")
...
![Data Format](./.artificial-intelligence_images/1707394569263.png "Data Format")
...
The [AI Model Resource](../../assets/workflow-assets/resources/asset-resource-ai-model.md) is used to define the technical details of the AI model.
You should create this resource before you start creating the Workflow.

![AI Model Resource](./.artificial-intelligence_images/1707319453946.png "AI Model Resource")
...
![AI model Attributes](./.artificial-intelligence_images/1707380780508.png)
...
In subsequent steps, this Resource is then used by the [AI Training Asset](../../assets/workflow-assets/processors-flow/asset-flow-ai-trainer.md) to train the model and then
the [AI Classifier Asset](../../assets/workflow-assets/processors-flow/asset-flow-ai-classifier.md) to use the model to infer the results.

#### 3. Create an AI Trainer Asset

Next, you create an [AI Training Asset](../../assets/workflow-assets/processors-flow/asset-flow-ai-trainer.md) (1).
This Asset is then used within a Workflow to train the AI model based on the training data and the AI Model Resource.

![AI Trainer Asset](./.artificial-intelligence_images/1707393993476.png "AI Trainer Asset")
...
![Trainer - AI Model attribute mapping](./.artificial-intelligence_images/1707395686887.png "[Trainer - AI Model attribute mapping")

#### 4. Create an AI Classification Asset

Next to the AI Trainer Asset, you create an [AI Classification Asset](../../assets/workflow-assets/processors-flow/asset-flow-ai-classifier.md) (1).
...
![AI Classifier Asset](./.artificial-intelligence_images/1707394836082.png "AI Classifier Asset")
...
![AI Classification Asset - Classification Attribute Mapping](./.artificial-intelligence_images/1707395085357.png "AI Classification Asset - Classification Attribute Mapping")

Again, the attributes in the data format are mapped to the attributes defined in the AI Model Resource (2).

![Classifier - AI Model attribute mapping](./.artificial-intelligence_images/1707395909667.png "Classifier - AI Model attribute mapping")
...
![Training Workflow](./.artificial-intelligence_images/1705930468563.png "Training Workflow")

At the center of the Workflow is an [AI Training Processor](../../assets/workflow-assets/processors-flow/asset-flow-ai-trainer.md) which uses the previously configured AI Training Asset to train the AI model based on
the training data.
...
At the center of the Workflow is an [AI Training Processor](../../assets/workflow-assets/processors-flow/asset-flow-ai-trainer.md) which is used to train the AI model.
Based on the incoming training data, the AI Training Asset will train the AI model and store it in the [AI Model Storage](../../operations/cluster/ai-storage.md).

![AI Storage](./.artificial-intelligence_images/1707397322308.png "AI Storage")
...
Alternatively, you can also use the [AI Model Storage](../../operations/cluster/ai-storage.md) to import and store a model that was trained outside layline.io.
...
![](./.artificial-intelligence_images/1705935241883.png "AI Production Workflow")

At the center of the Workflow is an [AI Classifier Processor](../../assets/workflow-assets/processors-flow/asset-flow-ai-classifier.md) which we previously created to infer data based on the input and the referenced AI
model.
The AI Classifier Processor will load the AI model from the [AI Model Storage](../../operations/cluster/ai-storage.md) and use it to come up with the data based on the input parameters.
...
In addition to this,
you can also define an [AI Service](../../assets/workflow-assets/services/asset-service-ai.md)
which you can use to access the AI Model Store within a [Javascript Asset](../../assets/workflow-assets/processors-flow/asset-flow-javascript.md).

![](./.artificial-intelligence_images/1705936929043.png)
...
* [AI Model Resource](../../assets/workflow-assets/resources/asset-resource-ai-model.md)
* [AI Training Asset](../../assets/workflow-assets/processors-flow/asset-flow-ai-trainer.md)
* [AI Classifier Asset](../../assets/workflow-assets/processors-flow/asset-flow-ai-classifier.md)
* [AI Service](../../assets/workflow-assets/services/asset-service-ai.md)
* [AI Model Storage](../../operations/cluster/ai-storage.md)
