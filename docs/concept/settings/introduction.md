---
title: Introduction (Configuration Server)
sidebar_position: 1
description: Introduction to Configuration Server settings.
tags:
- settings
...
This is where the _Configuration Server_ section comes which is where these more global settings can be defined.

![](.introduction-images/8495e89d.png "Overview (Configuration Server --> Introduction)")

### Configuration Server

Settings which change the content of the Configuration Server. Primarily **User Storage** and **Security Storage**.
...
This section defines Cluster Storage which is known to the Configuration Server.
