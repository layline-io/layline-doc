...
![](./.settings-user-storage_images/b6ee9bc8.png "User Storage Concept (Settings - User Storage)")
...
![](./.settings-user-storage_images/16-16-19-51.png "Users and Roles on the Configuration Server (Settings - User Storage)")

### User Storage Tab

The `User Storage Tab` shows information about the Controller and the current User:

![](./.settings-user-storage_images/16-16-14-47.png "User Storage Tab (Settings - User Storage)")
...
![](./.settings-user-storage_images/16-16-23-53.png "Edit user data (Settings - User Storage)")
...
![](./.settings-user-storage_images/16-16-29-50.png "Add a User (Settings - User Storage)")
...
![](./.settings-user-storage_images/16-16-36-03.png "Create a new User (Settings - User Storage)")
...
![](./.settings-user-storage_images/16-16-41-38.png "Change a User's settings (Settings - User Storage)")

#### Delete a User

To remove a User select the User in the tree. Then click on the down arrow and select `Remove`.

![](./.settings-user-storage_images/16-16-43-11.png "Delete a User (Settings - User Storage)")

### Roles Tab

The `Roles Tab` allows to manage Roles **(1)**.

![](./.settings-user-storage_images/16-16-50-31.png "Roles Tab (Settings - User Storage)")
...
![](./.settings-user-storage_images/16-16-53-42.png "Adding a Role (Settings - User Storage)")
