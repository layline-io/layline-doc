...
![Demo Workflow (Data Dictionary)](.data-dictionary_images/e4376256.png)
...
![Three data formats (Data Dictionary)](.data-dictionary_images/22fbc2da.png)
...
![F-In Format setup (Data Dictionary)](.data-dictionary_images/d0c719e1.png)

And then further down in the config:

![F-In Format setup Detail (Data Dictionary)](.data-dictionary_images/8eaa6834.png)

For the "_DD_" data dictionary format the setup in our example would be like this:

![DD Format (Data Dictionary)](.data-dictionary_images/83166182.png)
...
![Resulting Data Dictionary (Data Dictionary)](.data-dictionary_images/5abe2478.png)
...
![Flow of Data through Data Dictionary (Data Dictionary)](.data-dictionary_images/b0f6ecb6.png)
...
![Complete Internal Data Dictionary during processing (Data Dictionary)](.data-dictionary_images/c7c5ca99.png)
...
![Referencing data within Data Dictionary (Data Dictionary)](.data-dictionary_images/a5f90330.png)
...
![Add format as Workflow Dependency (Data Dictionary)](.data-dictionary_images/9030f09b.png)
