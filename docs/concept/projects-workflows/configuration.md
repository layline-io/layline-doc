...
You can find a detailed description of all available Assets and how they are configured, [here](../../assets/index.mdx). 
...
![](.configuration-images/27-17-33-45.png "Workflow Diagram View (Workflow Configuration)")
...
![](.configuration-images/01-10-27-19.png "Adding an Input Processor (Workflow Configuration)")
...
![](.configuration-images/01-10-28-44.png "Asset creation type (Workflow Configuration)")
...
![](.configuration-images/01-10-32-20.png "Adding a Mapping Processor (Workflow Configuration)")
...
![](.configuration-images/28-14-50-04.png "Check the Asset Viewer (Workflow Configuration)")
...
![](.configuration-images/28-17-03-08.png "Adding Formats (Workflow Configuration)")
...
![](.configuration-images/08-12-40-27.png "Input Source (Workflow Configuration)")

The Output Source Asset is named "_**Output Source**_" and the directories are defined like this:

![](.configuration-images/08-12-42-35.png "Output Source (Workflow Configuration)")
...
![](.configuration-images/28-17-26-13.png "Assigning Source and Format to the Input File Processor (Workflow Configuration)")

- Assign Format and Source by clicking the icons next to the fields

![](.configuration-images/28-17-27-57.png "Assigned Format and Source (Workflow Configuration)")
...
##### The Asset config:
![](.configuration-images/28-17-35-39.png "Asset Config (Workflow Configuration)")

##### The resulting File Output Processor config in the Workflow:
![](.configuration-images/28-17-38-51.png "The resulting File Output Processor config in the Workflow (Workflow Configuration)")
...
![](.configuration-images/29-10-46-52.png "Assign the File Input Format as a Dependency (Workflow Configuration)")
...
![](.configuration-images/29-10-51-29.png "Mapping Header, Detail, and Trailer (Workflow Configuration)")
...
![](.configuration-images/28-17-35-39.png "Result (Workflow Configuration)")
