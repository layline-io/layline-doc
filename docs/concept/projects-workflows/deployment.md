...
![](./.deployment-images/04-12-06-37.png "Deployment Tab (Workflow Deployment)")
...
![](./.deployment-images/01-09-48-58.png "Create a Cluster (Workflow Deployment)")
...
![](./.deployment-images/29-17-33-06.png "Example of how a Deployment is distributed in a Cluster (Workflow Deployment)")
...
![](./.deployment-images/04-11-56-24.png "Creating a Engine Configuration Asset (Workflow Deployment)")
...
![](./.deployment-images/01-09-56-44.png "Deploy to Cluster (Workflow Deployment)")
...
![](./.deployment-images/01-10-07-38.png "Login to Cluster (Workflow Deployment)")
...
![](./.deployment-images/01-10-52-04.png "Deploy directly to Cluster (Workflow Deployment)")
...
![](./.deployment-images/04-11-57-39.png "Select Cluster (Workflow Deployment)")
...
![](./.deployment-images/04-11-56-24.png "Check latest Deployment on Cluster (Workflow Deployment)")
...
The Deployment will be stored in a JSON-file which can be used for [upload in a Cluster](../../operations/cluster/index.md#deploy-from-file).
