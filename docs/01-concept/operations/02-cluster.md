...
![](.cluster-images/2021-11-01-15-38-20.png "Cluster architecture (Operations --> ")
...
![](.cluster-images/2021-11-01-16-59-25.png "Deployment Storage (Operations --> ")
...
![](.cluster-images/2021-11-03-16-31-18.png "How Deployments are stored (Operations --> ")
...
![](.cluster-images/2021-11-03-16-51-43.png "Deployment Configuration (Operations --> Cluster)")

There are two tabs "_**Deployments**_" **(1)** and "**Node Assignments**" **(2)**.

##### Deployments Tab

The _Deployments_ Tab gives you a tree view of the Deployments **(3)** which are known to the Cluster and also persisted thereon. We have explained earlier [how the Deployments are sent to a Cluster](/doc/01-concept/wf-config/deployment.html#deployment-run).
...
![](.cluster-images/2021-11-04-16-57-53.png "Node Assignment Tab (Operations --> Cluster)")
...
![](.cluster-images/2021-11-03-17-37-43.png "Making a Deployment a Default Deployment (Operations --> Cluster)")
...
![](.cluster-images/2021-11-03-17-49-43.png "Activating a Deployment on selected Nodes (Operations --> Cluster)")
...
As explained [here](/doc/01-concept/wf-config/deployment.html#deploy-to-file) a Deployment can be written to a file. To install this Deployment on the Cluster you can select `Upload Deployments` **(1)**:

![](.cluster-images/2021-11-04-15-59-59.png "Deploy from File (Operations --> Cluster)")

A upload dialog will open. You can add the Deployment file through the "_+_" sign **(1)** or via drag and drop **(2)**.

![](.cluster-images/2021-11-04-16-04-58.png "Upload Deployment from File (Operations --> Cluster)")
...
![](.cluster-images/2021-11-04-16-09-11.png "Upload Deployment --> Confirmation (Operations --> Cluster)")
...
![](.cluster-images/2021-11-04-16-51-10.png "Execute Deployment (Operations --> Cluster)")
...
![](.cluster-images/2021-11-04-18-46-07.png "How Workflows are scheduled (scaled) in a Cluster (Operations --> Cluster)")
...
![](.cluster-images/2021-11-05-13-55-23.png "Scheduler Settings (Operations --> Cluster)")
...
![](.cluster-images/2021-11-05-14-30-37.png "Box: Workflow Distribution in Cluster (Operations --> Cluster)")
...
![](.cluster-images/2021-11-08-13-55-15.png "Workflow distribution across nodes (Operations --> Cluster)")
...
![](.cluster-images/2021-11-08-14-26-14.png "Adding another Node to a Cluster (Operations --> Cluster)")
...
![](.cluster-images/2021-11-05-14-52-29.png "Box: Workflow Assignments (Operations --> Cluster)")
...
![](.cluster-images/2021-11-05-15-06-50.png "Box: Workflow Weight Distribution (Operations --> Cluster)")
...
![](.cluster-images/2021-11-08-15-24-04.png "Access Coordinator (Operations --> Cluster)")
...
![](.cluster-images/2021-11-08-15-40-10.png "Removing an item from the Source list (Operations --> Cluster)")
...
![](.cluster-images/2021-11-08-17-26-53.png "Freeing up resources (Operations --> Cluster)")
...
To learn how to manage Users, Roles and permissions within layline.io, please check [Operations User Storage](/doc/operations/operations-user-storage.md) for user management on the cluster, or .
