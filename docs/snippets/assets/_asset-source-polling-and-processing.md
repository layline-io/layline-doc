...
The `Reprocessing mode` setting controls how layline.io's [Access Coordinator](/docs/operations/cluster/cluster#access-coordinator) handles previously processed sources that are re-ingested.
