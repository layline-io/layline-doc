...
The `Reprocessing mode` setting controls how layline.io's [Access Coordinator](../../07-operations/cluster/cluster.md#access-coordinator) handles previously processed sources that are re-ingested.
