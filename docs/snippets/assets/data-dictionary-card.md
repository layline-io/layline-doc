...
- [Data Dictionary Format Asset](../../workflow-assets/formats/asset-format-data-dictionary) — standalone Data Dictionary asset
- [DynamoDB Service](../../workflow-assets/services/asset-service-dynamo-db) — Data Dictionary in context of a DynamoDB Service
- [JDBC Service](../../workflow-assets/services/asset-service-jdbc) — worked example mapping Data Dictionary types to SQL columns
