...
A Javascript Flow Processor, for example, which directly interacts with a database will have to react to a [rollback signal](../../04-language-reference/javascript/02-API/classes/JavaScriptProcessor.md#onrollback):
