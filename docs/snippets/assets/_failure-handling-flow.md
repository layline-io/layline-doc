...
A Javascript Flow Processor, for example, which directly interacts with a database will have to react to a [rollback signal](/docs/language-reference/javascript/API/classes/JavaScriptProcessor.md#onrollback):
...
- <VersionedLink to="/assets/workflow-assets/sources/asset-source-email">Email</VersionedLink>
- <VersionedLink to="/assets/workflow-assets/sources/asset-source-file">File</VersionedLink>
- <VersionedLink to="/assets/workflow-assets/sources/asset-source-ftp">FTP</VersionedLink>
- <VersionedLink to="/assets/workflow-assets/sources/asset-source-s3">S3</VersionedLink>
- <VersionedLink to="/assets/workflow-assets/sources/asset-source-smb">SMB</VersionedLink>
- <VersionedLink to="/assets/workflow-assets/sources/asset-source-webdav">WebDav</VersionedLink>
:::
