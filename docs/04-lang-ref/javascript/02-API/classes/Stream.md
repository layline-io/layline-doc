...
To roll back a stream, you may issue a [requestRollback](Stream.md#requestrollback-28) to signal to layline.io that you want this stream rolled back and provide a [Status](Status.md) which describes the reason for the rollback.
