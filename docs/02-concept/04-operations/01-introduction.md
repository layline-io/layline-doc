...
The setup of Clusters available for selection can only be done in an open Project under [Project --> Deployments](../projects-workflows/deployment#creating-a-cluster-asset). It is possible to either define 
