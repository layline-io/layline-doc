...
Based on the incoming training data, the AI Training Asset will train the AI model and store it in the [AI Model Storage](../../07-operations/cluster/cluster.md#ai-storage).
...
Alternatively, you can also use the [AI Model Storage](../../07-operations/cluster/cluster.md#ai-storage) to import and store a model that was trained outside layline.io.
...
model.
The AI Classifier Processor will load the AI model from the [AI Model Storage](../../07-operations/cluster/cluster.md#ai-storage) and use it to come up with the data based on the input parameters.
...
* [AI Model Storage](../../07-operations/cluster/cluster.md#ai-storage)
