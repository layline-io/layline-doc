...
Alternatively, you can also use the [AI Model Storage](/docs/concept/operations/cluster#ai-storage) to import and store a model that was trained outside layline.io.
