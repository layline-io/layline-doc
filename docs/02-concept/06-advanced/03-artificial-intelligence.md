...
The [AI Model Resource](../../03-assets/01-workflow-assets/resources/asset-resource-ai-model.md) is used to define the technical details of the AI model.
...
In subsequent steps, this Resource is then used by the [AI Training Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-trainer.md) to train the model and then
the [AI Classifier Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-classifier.md) to use the model to infer the results.

#### 3. Create an AI Trainer Asset

Next, you create an [AI Training Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-trainer.md) (1).
...
Next to the AI Trainer Asset, you create an [AI Classification Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-classifier.md) (1).
...
At the center of the Workflow is an [AI Training Processor](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-trainer.md) which uses the previously configured AI Training Asset to train the AI model based on
the training data.
...
At the center of the Workflow is an [AI Training Processor](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-trainer.md) which is used to train the AI model.
Based on the incoming training data, the AI Training Asset will train the AI model and store it in the [AI Model Storage](../../07-operations/02-cluster/01-cluster-overview.md#ai-storage).
...
Alternatively, you can also use the [AI Model Storage](../../07-operations/02-cluster/01-cluster-overview.md#ai-storage) to import and store a model that was trained outside layline.io.
...
At the center of the Workflow is an [AI Classifier Processor](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-classifier.md) which we previously created to infer data based on the input and the referenced AI
model.
The AI Classifier Processor will load the AI model from the [AI Model Storage](../../07-operations/02-cluster/01-cluster-overview.md#ai-storage) and use it to come up with the data based on the input parameters.
...
In addition to this,
you can also define an [AI Service](../../03-assets/01-workflow-assets/services/asset-service-ai.md)
which you can use to access the AI Model Store within a [Javascript Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-javascript.md).
...
* [AI Model Resource](../../03-assets/01-workflow-assets/resources/asset-resource-ai-model.md)
* [AI Training Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-trainer.md)
* [AI Classifier Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-ai-classifier.md)
* [AI Service](../../03-assets/01-workflow-assets/services/asset-service-ai.md)
* [AI Model Storage](../../07-operations/02-cluster/01-cluster-overview.md#ai-storage)
