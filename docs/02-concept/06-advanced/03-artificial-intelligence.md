...
The [AI Model Resource](/docs/assets/workflow-assets/resources/asset-resource-ai-model) is used to define the technical details of the AI model.
...
In subsequent steps, this Resource is then used by the [AI Training Asset](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-trainer) to train the model and then
the [AI Classifier Asset](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-classifier) to use the model to infer the results.

#### 3. Create an AI Trainer Asset

Next, you create an [AI Training Asset](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-trainer) (1).
...
Next to the AI Trainer Asset, you create an [AI Classification Asset](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-classifier) (1).
...
At the center of the Workflow is an [AI Training Processor](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-trainer) which uses the previously configured AI Training Asset to train the AI model based on
the training data.
...
At the center of the Workflow is an [AI Training Processor](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-trainer) which is used to train the AI model.
Based on the incoming training data, the AI Training Asset will train the AI model and store it in the [AI Model Storage](/docs/operations/cluster/cluster#ai-storage).
...
Alternatively, you can also use the [AI Model Storage](/docs/operations/cluster/cluster#ai-storage) to import and store a model that was trained outside layline.io.
...
At the center of the Workflow is an [AI Classifier Processor](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-classifier) which we previously created to infer data based on the input and the referenced AI
model.
The AI Classifier Processor will load the AI model from the [AI Model Storage](/docs/operations/cluster/cluster#ai-storage) and use it to come up with the data based on the input parameters.
...
In addition to this,
you can also define an [AI Service](/docs/assets/workflow-assets/services/asset-service-ai)
which you can use to access the AI Model Store within a [Javascript Asset](/docs/assets/workflow-assets/processors-flow/asset-flow-javascript).
...
* [AI Model Resource](/docs/assets/workflow-assets/resources/asset-resource-ai-model)
* [AI Training Asset](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-trainer)
* [AI Classifier Asset](/docs/assets/workflow-assets/processors-flow/asset-flow-ai-classifier)
* [AI Service](/docs/assets/workflow-assets/services/asset-service-ai)
* [AI Model Storage](/docs/operations/cluster/cluster#ai-storage)
