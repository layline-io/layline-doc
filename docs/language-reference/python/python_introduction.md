...
provides the [Python Asset](../../assets/workflow-assets/processors-flow/asset-flow-python.md).
...
One of the key methods here is [onMessage](./API/classes/PythonProcessor.md#on_message):

![](./.python_introduction_images/1725885495836.png "Lifecycle Hooks (Python Introduction)")
...
![Reusing Python (Python Introduction)](./.python_introduction_images/1725887215909.png "Reusing Python (Python Introduction)")
...
![Workflow activation failure due to Python runtime error (Python Introduction)](./.python_introduction_images/1725887426425.png "Workflow activation failure due to Python runtime error (Python Introduction)")
...
![](./.python_introduction_images/1725888514512.png)
