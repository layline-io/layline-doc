...
Access to such data sources/sinks is typically provided via [Services](../../../assets/workflow-assets/services/asset-service-introduction.md)
...
layline.io provides the feature of [Service Assets](../../../assets/workflow-assets/services/asset-service-introduction.md) in order to
...
to [Service JDBC](../../../assets/workflow-assets/services/asset-service-jdbc.md#link-enrichcustomer-processor-to-jdbc-service).
...
Note how the Service function returns a [Message](../API/classes/Message.md) as a result
type.
...
you are using.
There is for example a difference between [Service Aerospike](../../../assets/workflow-assets/services/asset-service-aerospike.md)
and [Service JDBC](../../../assets/workflow-assets/services/asset-service-jdbc.md#link-enrichcustomer-processor-to-jdbc-service).
