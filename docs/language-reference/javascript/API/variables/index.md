---
description: JavaScript global variable reference for layline.io — workflow, processor, stream, message, metrics, and more.
---
...
| [message](message.md) | [`Message`](../classes/Message.md) | The current message being processed. Automatically available in every JavaScript processor — no import needed. |
