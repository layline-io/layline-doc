...
provides the [Javascript Asset](../../assets/workflow-assets/processors-flow/asset-flow-javascript.md).
...
![](./.javascript_introduction_images/1721665632702.png "Reusing Javascript (Javascript Introduction)")
...
![](./.javascript_introduction_images/1721737268216.png "Deployment error due to wrong script reference (Javascript Introduction)")
...
![21d8ce9c.png](.javascript_introduction_images/21d8ce9c.png "Workflow activation failure due to Javascript runtime error (Javascript Introduction)")
