...
Access to such data sources/sinks is typically provided via [Services](../../../03-assets/01-workflow-assets/services/01-asset-service-introduction.md)
...
layline.io provides the feature of [Service Assets](../../../03-assets/01-workflow-assets/services/01-asset-service-introduction.md) in order to
...
to [Service JDBC](../../../03-assets/01-workflow-assets/services/asset-service-jdbc.md#link-enrichcustomer-processor-to-jdbc-service).
...
you are using.
There is for example a difference between [Service Aerospike](../../../03-assets/01-workflow-assets/services/asset-service-aerospike.md)
and [Service JDBC](../../../03-assets/01-workflow-assets/services/asset-service-jdbc.md#link-enrichcustomer-processor-to-jdbc-service).
