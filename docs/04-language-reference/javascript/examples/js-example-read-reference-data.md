...
Access to such data sources/sinks is typically provided via [Services](/docs/assets/workflow-assets/services/asset-service-introduction)
...
layline.io provides the feature of [Service Assets](/docs/assets/workflow-assets/services/asset-service-introduction) in order to
...
to [Service JDBC](/docs/assets/workflow-assets/services/asset-service-jdbc#link-enrichcustomer-processor-to-jdbc-service).
...
you are using.
There is for example a difference between [Service Aerospike](/docs/assets/workflow-assets/services/asset-service-aerospike)
and [Service JDBC](/docs/assets/workflow-assets/services/asset-service-jdbc#link-enrichcustomer-processor-to-jdbc-service).
