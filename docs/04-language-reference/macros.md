...
As a quick example, let's assume that you are configuring a [Amazon SQS Source](../03-assets/01-workflow-assets/sources/asset-source-sqs.md).
...
The Prefix `lay` references an environment property which you have defined in a [Environment Resource Asset](../03-assets/01-workflow-assets/resources/asset-resource-environment.md).
...
The Prefix `sec` references a secret property which you have defined in a [Environment Secret Asset](../03-assets/01-workflow-assets/resources/asset-resource-secret.md).
The suffix defines the value which you have defined for that property:
