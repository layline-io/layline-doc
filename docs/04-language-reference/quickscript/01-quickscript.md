...
QuickScript can be used in various places throughout the configuration of a layline.io Project. One example would be in the [Mapping Asset](../../03-assets/01-workflow-assets/processors-flow/asset-flow-mapping.mdx). 
...
- [Frame Output Processor](../../03-assets/01-workflow-assets/processors-output/asset-output-frame.md) --> in the routing rules
- [Filter & Routing Processor](../../03-assets/01-workflow-assets/processors-flow/asset-flow-filterrouting.mdx) --> in the filter & routing rules
- [Mapping Processor](../../03-assets/01-workflow-assets/processors-flow/asset-flow-mapping.mdx) --> in the mapping assignments
- [Generic Format](../../03-assets/01-workflow-assets/formats/04-asset-format-generic.md) --> in the grammar definition
...
This environment variable may have been defined in [Resource Environment Asset](../../03-assets/01-workflow-assets/resources/asset-resource-environment.md) or was defined via on system level.
:::tip
...
| **Example**    | Assuming that`lay:myEnvionmentVar` has been defined as "MyVar" in [Resource Environment Asset](../../03-assets/01-workflow-assets/resources/asset-resource-environment.md):<br/>`strExpand("This is ${lay:myEnvionmentVar}") // Replaces the environment variable lay:myEnvironmentVar and returns "This is MyVar".`<br/>`strExpand("${date:yyyy-MM-dd}")  // Expands to current date.` |
