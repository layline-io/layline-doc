...
* [MS Graph Connection](../../../../tions/asset-connection-msgraph)
...
Use the drop-down list to select an [MS Graph Connection](../../../../tions/asset-connection-msgraph) that should
support this OneDrive configuration. If it does not exist, you need to create it first.

:::info
Your [MS Graph Connection](../../../../tions/asset-connection-msgraph) needs to have the following configured scope:
