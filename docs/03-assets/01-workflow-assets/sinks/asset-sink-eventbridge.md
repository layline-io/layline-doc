...
Select the [AWS Connection](../../../../tions/asset-connection-aws) to use with this Asset.
...
_**Frame Output Processor**_ configurations will be selected. More details can be found [here](../../../../sors-output/asset-output-frame#sink-settings-for-eventbridge).
