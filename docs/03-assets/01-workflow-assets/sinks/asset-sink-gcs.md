...
- A [**Google Cloud Connection**](../../../../tions/asset-connection-google-cloud) asset configured with the appropriate OAuth scopes.
...
](.asset-sink-gcs_images/as.asset-sink-gcs-name-description.png "Name & Description (Sink GCS)")
...
](.asset-sink-gcs_images/as.asset-sink-gcs-required-roles.png "Required Roles (Sink GCS)")
...
](.asset-sink-gcs_images/as.asset-sink-gcs-settings.png "Google Cloud Storage Settings (Sink GCS)")
...
- [**Google Cloud Connection**](../../../../tions/asset-connection-google-cloud) — Authentication for GCS assets
