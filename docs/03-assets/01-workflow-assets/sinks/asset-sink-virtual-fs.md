...
- [**VFS Source**](../../../../s/asset-source-virtual-fs) — Read files from a VFS mount
- [**VFS Connection**](../../../../tions/asset-connection-virtual-fs) — VFS connection configuration
- [**SMB Sink**](../../../../asset-sink-smb) — Write files to SMB/CIFS shares
