...
| Asset type        | Link                                                              |
|-------------------|-------------------------------------------------------------------|
| Output Processors | [Frame Output Processor](../../../../sors-output/asset-output-frame) |

### Prerequisite

You need:

* [Kafka Connection](../../../../tions/asset-connection-kafka)
...
Select the [Kafka Connection](../../../../tions/asset-connection-kafka) to use with this Asset.
