...
Select the [AWS Connection](../../../../tions/asset-connection-aws) to use for this Asset. If it does not exist, you need to create it first.
...
* [S3 Connection](../../../../tions/asset-connection-aws)
