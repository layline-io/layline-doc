...
* [EventBridge](../../../../asset-sink-eventbridge)
* [Kafka](../../../../asset-sink-kafka)
* [Kinesis](../../../../asset-sink-kinesis)
* [SNS](../../../../asset-sink-sns)
* [SQS](../../../../asset-sink-sqs)
...
](.asset-output-frame_images/6143c389.png)
...
](.asset-output-frame_images/22cde544.png)
...
](.asset-output-frame_images/5c1a78f7.png)
...
Conditions follow the [Quickscript](../../../../../../../erence/quickscript/quickscript) language.
...
* **`Event Buses`**: You can forward each message to one or more EventBridge Event Buses.
  ...
  An Event Bus reference can be selected from Event Buses which you have already defined in an [Event Bridge Sink](../../../../asset-sink-eventbridge),
  or you can define a term which returns the Event Bus name through a [Quickscript](../../../../../../../erence/quickscript/quickscript) term.

    * **Constant**: Pick this option to select from Event Buses which you have defined in an [Event Bridge Sink](../../../../asset-sink-eventbridge).
      Select the available Event Buses from the drop-down on the right:

  ](.asset-output-frame_images/bc80c560.png)

    * **Calculated**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which evaluates to an Event Bus name.
      You can also use $\{...\} macros to expand variables defined in [environment variables](../../../../ces/asset-resource-environment).
...
* **`Event detail message accessor`**: At this point you define which data from the message you want to map to the output.
  ...
  To learn more about messages and data dictionary, please check [here](../../../../../../../-dictionary).
...
](.asset-output-frame_images/317cae17.png)
...
](.asset-output-frame_images/09193941.png)
...
* **`Topic`**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which evaluates to the topic name of where you want to send the individual message.
  ...
  ](.asset-output-frame_images/372b0658.png)
...
](.asset-output-frame_images/d3dedd0f.png)
...
](.asset-output-frame_images/81cb2984.png)
...
* **`Kinesis Stream`**: Enter a term (Constant) or a QuickScript (Calculated) which is passed to Kinesis as the stream name to which the data should be written.
  ...
  It acts as a durable and ordered log of the data records. The stream parameter is used to identify the stream to which you want to send or receive data.
    ...
    * **Constant**: Pick this option to select from Streams which you have defined in a [Kinesis Sink](../../../../asset-sink-kinesis).
    ...
    * **Calculated**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which evaluates to an SNS topic name.
      You can also use $\{...\} macros to expand variables defined in [environment variables](../../../../ces/asset-resource-environment).
      Make sure the result is enclosed in quotes as a result to form a valid result string.
...
* **`Partition Key`**: Enter a term (Constant) or a QuickScript (Calculated) which is passed to Kinesis as the stream name to which the data should be written.
  ...
  A well-distributed partition key can help to ensure optimal parallel processing and efficient utilization of resources within your Kinesis application.
    ...
    * **Calculated**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which evaluates to Kinesis Partition Key.
      You can also use $\{...\} macros to expand variables defined in [environment variables](../../../../ces/asset-resource-environment).
      Make sure the result is enclosed in quotes as a result to form a valid result string.
...
* **`Topic`**: Enter a term (Constant) or a QuickScript (Calculated) which is passed to SNS as the topic name to which the data should be written.
    ...
    * **Constant**: Pick this option to select from Topics which you have defined in an [SNS Sink](../../../../asset-sink-sns).
...
* **`Deduplication Id`**: Define whether you want to pass an SNS deduplication id on, and if so, how this should be generated.
  ...
  You have the choice of the following options:
    ...
    * **`Calculated`**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which returns a deduplication id.
...
* **`Phone number`**: In case messages should be sent via SNS to a phone or email address, enter the respective information here.
  ...
  You have the choice of the following options:
    ...
    * **`Calculated`**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which returns phone number or email address.
...
* **`Subject`**: In case messages should be sent via SNS to a phone or email address, enter the respective information here.
  ...
  You have the choice of the following options:
    ...
    * **`Calculated`**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which returns a subject string.
      This is especially useful if the message contains a specific field which contains the necessary information.
...
* **`Queue`**: Enter a term (Constant) or a QuickScript (Calculated) which is passed to SQS as the queue name to which the data should be written.
    ...
    * **Constant**: Pick this option to select from Queues which you have defined in an [SQS Sink](../../../../asset-sink-sqs).
    ...
    * **Calculated**: Enter a [Quickscript](../../../../../../../erence/quickscript/quickscript) term which evaluates to an SQS topic name.
      You can also use $\{...\} macros to expand variables defined in [environment variables](../../../../ces/asset-resource-environment).
      Make sure the result is enclosed in quotes as a result to form a valid result string.
