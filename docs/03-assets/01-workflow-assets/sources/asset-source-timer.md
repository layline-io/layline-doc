...
* [Input Message](../../../../sors-input/asset-input-message)
...
](.asset-source-timer_images/image_2025-03-18-09-28-06.png "Operation Mode (Timer Source)")
...
So instead of defining timers within the Timer Source, you will define them in the [Timer Service](../../../../es/asset-service-timer).

](.asset-source-timer_images/image_2025-03-18-16-53-44.png "Using timer service (Timer Source)")

#### Stream Settings

In this section you define whether you want to create timed batches, or timed events.

](.asset-source-timer_images/image_2025-03-18-16-34-43.png "Stream Type (Timer Source)")
...
](.asset-source-timer_images/image_2025-03-18-16-37-51.png "Batch Stream (Timer Source)")
...
* **`Batch closing mode`** : `Batch Stream` mode allows you to define when to close the batch. There are three modes available:
    ...
    1. **`Immediately`** : The batch is closed right after being opened. No payload is being sent.
       ...
       Note that since no payload will be sent in this mode, there is no point to have a `onMessage` reaction in any of your scripts. You also do not require to set a [Timer](../../../../s/asset-source-timer#timers). It will never fire  because the stream will immediately terminate.
...
](.asset-source-timer_images/image_2025-03-18-16-39-40.png "Event Stream (Timer Source)")
...
### Internal
* [Input Message](../../../../sors-input/asset-input-message)
* [Timer Service](../../../../es/asset-service-timer)
