...
| Asset type       | Link                                                            |
|------------------|-----------------------------------------------------------------|
| Input Processors | [Stream Input Message](../../../../sors-input/asset-input-message) |

### Prerequisite

You need:

* [Email Connection](../../../../tions/asset-connection-email)
...
Use the drop-down list to select an [Email Connection](../../../../tions/asset-connection-email) that should
support this Email configuration. If it does not exist, you need to create it first.

:::info
Your [Email Connection](../../../../tions/asset-connection-email) needs to have the following configured scope:
...
You need to ensure that the name is unique. As you can see from the example above, you can use [Macros](../../../../../../../erence/macros) here.
