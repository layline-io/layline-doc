...
A Service Source allows the integration of a configured [Service Assets](../../../../es) to be used as a data input source.
...
Depending on their setup other Service Assets like [Http](../../../../es/asset-service-http) or [SOAP](../../../../es/asset-service-soap) might also serve the input data aspect. 
...
](.asset-source-service_images/image_2025-03-26-22-09-25.png "Service Source Asset")

### This Asset can be used by:

| Asset type       | Link                                                                         |
|------------------|------------------------------------------------------------------------------|
| Input Processors | [Service Input Processor](../../../../sors-input/asset-input-service) |
...
* [Aerospike](../../../../es/asset-service-aerospike)
* [Cassandra](../../../../es/asset-service-cassandra)
* [Hazelcast](../../../../es/asset-service-hazelcast)
* [Http](../../../../es/asset-service-http)
* [JDBC](../../../../es/asset-service-jdbc)
* [SOAP](../../../../es/asset-service-soap)
...
](.asset-source-service_images/image_2025-03-26-17-59-00.png "Polling and Processing (Service Source)")
...
A unique `Object name` configuration is necessary and relates to layline.io's [Access Coordinator](../../../../../../../luster/cluster#access-coordinator) feature. 
The [Sources Coordinator](../../../../../../../luster/cluster#sources-coordinator-tab-2) will show the here defined object name in its list of sources processed. 
As you can see from the screenshot above, you can use [Macros](../../../../../../../erence/macros) here.
...
* **`Stream name`** : Name to apply for the Stream created by this Service Source. You should ensure that the name is unique. 
  As you can see from the example in the image above, you can use [Macros](../../../../../../../erence/macros) here.
