...
| Asset type       | Link                                                                                           |
|------------------|------------------------------------------------------------------------------------------------|
| Input Processors | [Request-Response Input Processor](../../../../sors-input/asset-input-request-response) |

### Prerequisite

* [Http-Format(s)](../../../../s/asset-format-http)
...
Assign 1-n configured [Http-Format(s)](../../../../s/asset-format-http) that should be handled through the configured Http-Server.
...
The configuration of a [Request-Response Input Processor](../../../../sors-input/asset-input-request-response) using this Http Source Asset 
...
Activating these check-boxes allow investigations through logs made available within the [Sources Operations - Engine State](../../cs/operations/engine-state/sources).
