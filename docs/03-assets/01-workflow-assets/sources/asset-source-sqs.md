...
| Asset type       | Link                                                                     |
|------------------|--------------------------------------------------------------------------|
| Input Processors | [Frame Input Processor](../../../../sors-input/asset-input-frame) |

### Prerequisite

You need:

* [AWS Connection](../../../../tions/asset-connection-aws)
...
Use the drop-down list to select an [AWS Connection](../../../../tions/asset-connection-aws) that should support this Asset. If it does not exist, you need to create it first.
...
could be: You can use $\{...\} macros to expand variables defined in [environment variables](../../../../ces/asset-resource-environment).
...
Within lalyine.io you need to ensure this behavior by adding the [Input Frame Committer](../../../../sors-flow/asset-flow-input-frame-committer) processor into your workflow since this is the instance that would finally delete the message from the queue.
