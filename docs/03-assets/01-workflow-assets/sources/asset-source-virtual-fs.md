...
| Asset type       | Link                                                               |
|------------------|--------------------------------------------------------------------|
| Input Processors | [Stream Input Processor](../../../../sors-input/asset-input-stream)   |

### Prerequisite

You need:

- A [**Virtual File System Connection**](../../../../tions/asset-connection-virtual-fs)

## Configuration

### Name & Description

![Name & Description (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-name-description.png "Name & Description (Virtual File System Source)")
...
![Required Roles (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-required-roles.png "Required Roles (Virtual File System Source)")
...
![Virtual File System Settings (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-vfs-settings.png "Virtual File System Settings (Virtual File System Source)")
...
![Folders Toolbar (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-folders-toolbar.png "Folders Toolbar (Virtual File System Source)")
...
![Folder Configuration Detail (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-folders-detail.png "Folder Configuration Detail (Virtual File System Source)")
...
![Input Directory (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-input-dir.png "Input Directory (Virtual File System Source)")
...
![Done Directory (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-done-dir.png "Done Directory (Virtual File System Source)")
...
![Error Directory (Virtual File System Source)![Image](./.Virtual_File_System_Source_images/vfs-source-error-dir.png "Error Directory (Virtual File System Source)")
