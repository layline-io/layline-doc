...
Polls one or more Google Cloud Storage (GCS) buckets for objects and makes them available to downstream processors. Authentication is handled via a [Google Cloud Connection](../../../../tions/asset-connection-google-cloud) using OAuth 2.0. Objects can be filtered by prefix, suffix, and regular expression patterns. Housekeeping rules can be configured to automatically delete processed objects after a configurable age threshold.
...
- A [**Google Cloud Connection**](../../../../tions/asset-connection-google-cloud) with a valid OAuth client configured
...
- [**Google Cloud Connection**](../../../../tions/asset-connection-google-cloud) — OAuth configuration for GCS access
- [**GCS Sink**](../../../../asset-sink-gcs) — Write objects to Google Cloud Storage
- [**VFS Source**](../../../../s/asset-source-virtual-fs) — Read files from a Virtual File System mount
