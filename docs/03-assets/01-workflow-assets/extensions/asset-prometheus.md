...
The Prometheus Extension is assigned to a [Project](../../../../ts-workflows/project) or an [Engine Configuration](../../../../ment/asset-configuration-engine) to enable metric export.

:::tip See Also
For a full list of available default metrics and how to configure Prometheus + Grafana, see [Gathering Statistics through Metrics](../../../../../../../nced/prometheus-extension).
:::
...
| Deployment | [Engine Configuration](../../../../ment/asset-configuration-engine) |
...
![Image](./.asset-prometheus_images/prometheus-mappings-example.png "Prometheus Mappings — wildcard placeholder example")
