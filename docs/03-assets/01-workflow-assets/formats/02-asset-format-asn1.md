...
| Asset type        | Link                                                                       |
|-------------------|----------------------------------------------------------------------------|
| Input Processors  | [Kafka Input](../../../../sors-input/asset-input-kafka)                       |
|                   | [Request-Response Input](../../../../sors-input/asset-input-request-response) |
|                   | [Stream Input](../../../../sors-input/asset-input-stream)                     |
|                   | [Frame Input](../../../../sors-input/asset-input-frame)                       |
| Output Processors | [Stream Output](../../../../sors-output/asset-output-stream)                  |
...
](-as.asset-format-generic_images/bbd2a7a6.png)
...
](-as.asset-format-asn1_images/6e5cda26.png)
...
](-as.asset-format-asn1_images/5792e17b.png)
...
](-as.asset-format-asn1_images/53656035.png)
...
](-as.asset-format-asn1_images/aa822330.png)
...
* **`Data Dictionary Namespace`** (optional):
  ...
  See also [createMessage](../../../../../../../erence/javascript/API/classes/DataDictionary#createmessage).
...
* **`ASN.1 module`**:
  ...
  ](-as.asset-format-asn1_images/8d9cea11.png)
...
](-as.asset-format-asn1_images/d70ad41b.png)
...
](-as.asset-format-asn1_images/ad6df218.png)
...
* **Message mapping**:
  ...
  ](-as.asset-format-asn1_images/32bd48a5.png)
  ...
  ](-as.asset-format-asn1_images/5f03deaa.png)
  ...
  ](-as.asset-format-asn1_images/1dc27d41.png)
...
](-as.asset-format-asn1_images/337d90e7.png)
...
](-as.asset-format-asn1_images/f5d21bfa.png)
...
](-as.asset-format-asn1_images/cfd1ba06.png)
...
](-as.asset-format-asn1_images/a042463c.png)
...
](-as.asset-format-asn1_images/d285b558.png)
...
](-as.asset-format-asn1_images/011bac28.png)
