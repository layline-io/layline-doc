...
The Http-Format Asset defines Http-Rest-Interfaces which can be used together with a [Request-Response Input](../../../../sors-input/asset-input-request-response) Processor.
...
Please check the [Request-Response Input](../../../../sors-input/asset-input-request-response) Processor for more insight and adequate examples.

### This Asset can be used by:

| Asset type       | Link                                                                 |
|------------------|----------------------------------------------------------------------|
| Input Processors | [Request-Response](../../../../sors-input/asset-input-request-response) |
| Source           | [Http Source](../../../../s/asset-source-http)                          |
...
](-as.asset-format-http_images/1140f0fa.png)
...
](-as.asset-format-http_images/cc6801b8.png)
...
](-as.asset-format-http_images/a9ce2f59.png)

A new path will be created with some default parameters.

](-as.asset-format-http_images/89f9f7e9.png)
...
* **`Http Path`**: The actual http url part of the path under which the http methods can be reached.
  ...
  The workflow has a [Request-Response Input](../../../../sors-input/asset-input-request-response) which is bound to a Source Asset which opens port 4712 under address `https://mycluster.mydomain.com`.
...
](-as.asset-format-data-dictionary_images/2debae71.png)
...
](-as.asset-format-data-dictionary_images/b6aa3038.png)
...
](-as.asset-format-data-dictionary_images/da98aee2.png)
...
](-as.asset-format-data-dictionary_images/7b85f606.png)
...
](-as.asset-format-data-dictionary_images/22d42e10.png)

A new element `Namespace1` will be created. Click on it to select it.

](-as.asset-format-data-dictionary_images/c1c8e3d7.png)
...
](-as.asset-format-data-dictionary_images/480fb315.png)
...
](-as.asset-format-data-dictionary_images/0f674855.png)

and define the following elements:

](-as.asset-format-data-dictionary_images/7e60b638.png)
...
](-as.asset-format-data-dictionary_images/d9cb62f6.png)
...
](-as.asset-format-data-dictionary_images/473f0e6e.png)

Then add the `Boat` element:

](-as.asset-format-data-dictionary_images/4ea5db37.png)
...
](-as.asset-format-data-dictionary_images/da294ebc.png)
...
](-as.asset-format-data-dictionary_images/04be6b3e.png)
...
](-as.asset-format-data-dictionary_images/1e4b0161.png)
...
](-as.asset-format-data-dictionary_images/f649ef9e.png)
...
](-as.asset-format-data-dictionary_images/732e9977.png)
...
](-as.asset-format-data-dictionary_images/98be4609.png)
...
](-as.asset-format-data-dictionary_images/80b1043f.png)
...
](-as.asset-format-data-dictionary_images/66568fa2.png)
...
](-as.asset-format-data-dictionary_images/7ded88e8.png)

Next, we add the conditions for when these should be selected, based on the incoming information:

](-as.asset-format-data-dictionary_images/771363a7.png)
...
](-as.asset-format-data-dictionary_images/d8418308.png)
...
](-as.asset-format-data-dictionary_images/1f2abef2.png)
...
To understand how to work with the Data Dictionary in Javascript, [check here](../../../../../../../erence/javascript).
:::
