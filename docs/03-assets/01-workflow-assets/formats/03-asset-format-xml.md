...
- [Stream Input](../../../../sors-input/asset-input-stream) / [Stream Output](../../../../sors-output/asset-output-stream)
- [Frame Input](../../../../sors-input/asset-input-frame) / [Frame Output](../../../../sors-output/asset-output-frame)
...
![XML Settings — XSD Schema selector and Schema setup table](./.asset-format-xml_images/01-xml-settings.png)
...
![XML Settings — Pretty printing checkbox](./.asset-format-xml_images/01-xml-settings.png)
...
![Message Creation — context and element path mapping](./.asset-format-xml_images/02-message-creation.png)
...
![Converters — context and pre-defined converter type selection](./.asset-format-xml_images/03-converters.png)

For more on using formats in processors, see [Stream Input](../../../../sors-input/asset-input-stream) and [Frame Input](../../../../sors-input/asset-input-frame).
