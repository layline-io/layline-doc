...
* Knowledge on how to work with Javascript in layline.io. Please check
  the [Javascript Language Reference](../../../../../../../erence/javascript/javascript_introduction) to learn about this.
...
the [Javascript Language Reference](../../../../../../../erence/javascript/javascript_introduction).
:::
...
method [here](../../../../../../../erence/javascript/API/classes/Processor#getarguments), on how to retrieve arguments in the script.
...
- [JavaScript Language Reference](../../../../../../../erence/javascript/javascript_introduction) — full JavaScript language guide for layline.io
- [JavaScriptProcessor API](../../../../../../../erence/javascript/API/classes/JavaScriptProcessor) — available hooks and lifecycle methods
- [DataDictionary API](../../../../../../../erence/javascript/API/classes/DataDictionary) — working with Reference Data in scripts
- [PackedMessage API](../../../../../../../erence/javascript/API/classes/PackedMessage) — reading and writing message fields
