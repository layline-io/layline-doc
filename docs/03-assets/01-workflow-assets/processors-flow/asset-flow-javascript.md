...
method [here](../../../04-language-reference/javascript/02-API/classes/Processor.md#getarguments), on how to retrieve arguments in the script.
...
- [JavaScriptProcessor API](../../../04-language-reference/javascript/02-API/classes/JavaScriptProcessor.md) — available hooks and lifecycle methods
- [DataDictionary API](../../../04-language-reference/javascript/02-API/classes/DataDictionary.md) — working with Reference Data in scripts
- [PackedMessage API](../../../04-language-reference/javascript/02-API/classes/PackedMessage.md) — reading and writing message fields
