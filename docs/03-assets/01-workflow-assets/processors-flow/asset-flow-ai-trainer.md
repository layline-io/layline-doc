...
The trained model is then used by an [AI Classifier](../../../t-flow-ai-classifier) Processor to classify new messages.
...
](.asset-flow-ai-trainer_images/ai-storage-models.png)
...
1. An **[AI Model Resource](../../../../ces/asset-resource-ai)** that defines the model's input/output attributes, model type (e.g., J48 Decision Tree, Multilayer Perceptron), and hyperparameters
...
](.asset-flow-ai-trainer_images/ai-trainer-training-settings.png)
...
| **Path in AI Storage** | The path in AI Storage where the trained model will be stored (e.g., `models/my-classifier`). Supports [macros](../../../../../../../erence/macros) for per-environment values. |
...
](.asset-flow-ai-trainer_images/ai-trainer-model-selector.png)
...
- [AI Classifier](../../../t-flow-ai-classifier) — for applying a trained model to classify new messages
- [AI Model Resource](../../../../ces/asset-resource-ai) — for defining the model's input/output schema, algorithm type, and hyperparameters
- [AI Service](../../../../es/asset-service-ai) — for defining the interface to an AI model
- [Operations → AI Storage](../../../../ions/cluster/cluster#ai-storage) — for managing trained models in AI Storage
