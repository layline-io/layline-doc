...
route, you can always use the [Javascript Flow Processor Asset](./asset-flow-javascript) to freely handle message filtering, routing, and whatever else you plan to do with
the message.
