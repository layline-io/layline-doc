...
](.asset-flow-input-frame-committer_images/dropdown.png)
...
](.asset-flow-input-frame-committer_images/editor.png)
...
](.asset-flow-input-frame-committer_images/workflow.png)
...
- [SQS Source](../../../../s/asset-source-amazon-sqs) — message source that attaches `InputFrame` to SQS messages
- [Kafka Source](../../../../s/asset-source-apache-kafka) — message source that attaches `InputFrame` to Kafka records
- [Input Frame Processor](../../../t-flow-input-frame) — counterpart that attaches `InputFrame` to messages; Input Frame Committer finalizes messages that carry it
