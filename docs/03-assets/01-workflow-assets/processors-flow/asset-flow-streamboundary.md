...
](.asset-flow-streamboundary_images/9bccfd9c.png)
...
](.asset-flow-streamboundary_images/6f497f41.png)
...
](.asset-flow-streamboundary_images/8e83ce05.png)
...
](.asset-flow-streamboundary_images/a845393c.png)
...
](.asset-flow-streamboundary_images/5e2d478d.png)

As you can see from the example above, you can use [Macros](../../../../../../../erence/macros) here.
...
](.asset-flow-streamboundary_images/c6384bbb.png)
...
](.asset-flow-streamboundary_images/15cf0046.png)
...
](.asset-flow-streamboundary_images/1fd6113c.png)
...
](.asset-flow-streamboundary_images/c7d792e0.png)

A State will be automatically inserted in the table below. 
We name the State `Header`.

](.asset-flow-streamboundary_images/768c80db.png)
...
](.asset-flow-streamboundary_images/4b0ee520.png)
...
](.asset-flow-streamboundary_images/6cc02492.png)
...
](.asset-flow-streamboundary_images/9b7b3e04.png)
...
](.asset-flow-streamboundary_images/fdf511b0.png)

We now have a new `Case` for which we can enter the details:

](.asset-flow-streamboundary_images/216f2497.png)
...
](.asset-flow-streamboundary_images/1511c3e3.png)
...
](.asset-flow-streamboundary_images/0d357b7e.png)

| Splitter Action                        | Effect                                                                                                                                                                                      | Other options                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |   |
|----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---|
| **Start Downstream**                   | Start a new stream. The original message is **NOT** forwarded.                                                                                                                              | - `Stream Name`: Name of the newly created stream.<br/>You can use [Macros](../../../../../../../erence/macros) here.<br/>Example: `${msg:Header.Name}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |   |
...
](.asset-flow-streamboundary_images/ea7fc47b.png)
...
](.asset-flow-streamboundary_images/04ce59a6.png)
...
](.asset-flow-streamboundary_images/9e463a64.png)

#### Complete Example Configuration

If we complete all settings based on our example, we come up with the following:

](.asset-flow-streamboundary_images/1273b915.png)
