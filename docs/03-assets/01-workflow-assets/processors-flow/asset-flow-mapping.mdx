...
import AssetConditions from '../../../snippets/assets/_asset-conditions.mdx';
...
](.asset-flow-mapping_images/9a2b7358.png)
...
To perform mapping you should have a solid understanding of **[layline.io's Data Dictionary concept](../../../../../../../-dictionary)**.
:::

#### Adding a new mapping scenario

](.asset-flow-mapping_images/4b59ef93.png)

In this section you will define the actual format mapping.
Initially no scenarios are configured.

](.asset-flow-mapping_images/057e1f0d.png)

Select `Add a new scenario` from the drop-down box:

](.asset-flow-mapping_images/22f0aadb.png)

#### Scenario Name and Description

Each Mapping Scenario must have a unique name and can have a description:

](.asset-flow-mapping_images/84eb7136.png)
...
](.asset-flow-mapping_images/fa6fe475.png)

e.g.:

](.asset-flow-mapping_images/24ecaa1e.png)
...
](.asset-flow-mapping_images/6cdd8f29.png)
...
](.asset-flow-mapping_images/9e9bc6f1.png)

A new step is created.

](.asset-flow-mapping_images/f729049d.png)
...
](.asset-flow-mapping_images/2d8586ba.png)
...
](.asset-flow-mapping_images/c0a8d469.png)

As the little "_qs_" icon to the right implies, and is shown in the example, you can use [Quickscript](../../../../../../../erence/quickscript) here.
...
](.asset-flow-mapping_images/ddf03005.png)
