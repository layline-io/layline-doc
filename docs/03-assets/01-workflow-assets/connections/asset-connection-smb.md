...
| Asset type | Link                                                |
|------------|-----------------------------------------------------|
| Source     | [SMB Source](../../../../s/asset-source-smb) |
| Sink       | [SMB Sink](../../../../asset-sink-smb)       |

## Configuration

### Name & Description

](.asset-connection-smb_images/0243a9e1.png)
...
](.asset-connection-smb_images/bdbf6d1b.png)
...
](.asset-connection-smb_images/38c3b2ba.png)
