...
| Asset type | Link                                                    |
|------------|---------------------------------------------------------|
| Source     | [Kafka Source](../../../../s/asset-source-kafka) |
| Sink       | [Kafka Sink](../../../../asset-sink-kafka)       |
...
* **`Use identitity certificate`**: Select the secret necessary to decrypt the truststore. If this list is empty, then you first need to create it [here](../../../../ces/asset-resource-secret).
...
* **`Keystore password secret`**: Select the secret necessary to decrypt the keystore. If this list is empty, then you first need to create it [here](../../../../ces/asset-resource-secret).
  This entry is equivalent to the `ssl.keystore.password` property.
  Example: `test1234`

* **`Key password secret`**:  Password secret for decryption of Key in Keystore. If this list is empty, then you first need to create it [here](../../../../ces/asset-resource-secret).
...
* **`User/Secret`**:
  Enter a `Username` and select a `Secret` from the drop-down list. It the list is empty, then you need to first [create a secret](../../../../ces/asset-resource-secret) to be able to assign it
  here.

  Please [follow this link to "Advanced Concepts"](../../../../../../../nced/secret-management) to learn about the concept and use of the Security Storage.
...
* [Kafka Source](../../../../s/asset-source-kafka)
* [Kafka Sink](../../../../asset-sink-kafka)
* [Kafka Input Processor](../../../../sors-input/asset-input-kafka)
* [Frame Output Processor](../../../../sors-output/asset-output-frame)
