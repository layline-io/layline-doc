...
| Asset type | Link                                             |
|------------|--------------------------------------------------|
| Source     | [Email Source](../../../../s/asset-source-email)    |
| Service    | [Email Service](../../../../es/asset-service-email) |

## Configuration

### Name & Description

](.asset-connection-email_images/45509d51.png)
...
](.asset-connection-email_images/Screenshot2024-04-24Email_Connection_Type.png)
...
](.asset-connection-email_images/c2a8d834.png)
...
](.asset-connection-email_images/94bd0306.png)
...
](.asset-connection-email_images/41081856.png)
...
](.asset-connection-email_images/2f896529.png)
