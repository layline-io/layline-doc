...
| Asset type | Link                                                          |
|------------|---------------------------------------------------------------|
| Source     | [S3 Source](../../../../s/asset-source-s3)             |
|            | [SQS Source](../../../../s/asset-source-sqs)           |
| Sink       | [S3 Sink](../../../../asset-sink-s3)                   |
|            | [SNS Sink](../../../../asset-sink-sns)                 |
|            | [SQS Sink](../../../../asset-sink-sqs)                 |
|            | [Kinesis Sink](../../../../asset-sink-kinesis)         |
|            | [EventBridge Sink](../../../../asset-sink-eventbridge) |
...
](.asset-connection-aws_images/6f1da8c1.png "Name & Description (Connection AWS)")
...
](.asset-connection-aws_images/c2e6ec39.png "Required Roles (Connection AWS)")
...
](.asset-connection-aws_images/82f074a4.png "Access Key and Secret - manual entry (Connection AWS)")
...
* **`Use Secret`**: Check this box, if you have a configured a secret and want to reference this here
  ...
  Pick one of the Secrets in the list. The Secret must have been defined in a [Secrets Resource](../../../../ces/asset-resource-secret).
  You cannot manually enter a secret here.

](.asset-connection-aws_images/79a368d8.png "Use Secret (Connection AWS)")
...
](.asset-connection-aws_images/3154d354.png "Use alternative provider (Connection AWS)")

or use a placeholder:

](.asset-connection-aws_images/733e35fc.png "Use alternative provider with placeholder (Connection AWS)")

#### Connection test

The UI will constantly try to verify your connection credentials and show the results at the bottom of the box:

](.asset-connection-aws_images/cb0f4340.png "Connection testing in progress (Connection AWS)")
...
](.asset-connection-aws_images/d43aa264.png "Connection successful (Connection AWS)")
...
](.asset-connection-aws_images/5dce7c94.png "Connection failed (Connection AWS)")
...
* [S3 Source](../../../../s/asset-source-s3)
* [S3 Sink](../../../../asset-sink-s3)
* [Create and manage secrets](../../../../ces/asset-resource-secret)
