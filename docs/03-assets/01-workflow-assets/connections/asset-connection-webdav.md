...
| Asset type | Link                                                      |
|------------|-----------------------------------------------------------|
| Source     | [WebDav Source](../../../../s/asset-source-webdav) |
| Sink       | [WebDav Sink](../../../../asset-sink-webdav)       |

## Configuration

### Name & Description

](.asset-connection-webdav_images/75395c1a.png)
...
](.asset-connection-webdav_images/be14e27b.png)
...
* **`Secret`**:
  Select a `Secret` from the drop-down list. If the list is empty, then you need to first [create a secret](../../../../ces/asset-resource-secret) to be able to assign it here.
...
Read here [how to do this](../../../../../../../nced/secret-management#importing-a-trusted-certificate-3).
:::
