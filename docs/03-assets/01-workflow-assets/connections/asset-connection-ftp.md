...
| Asset type | Link                                                |
|------------|-----------------------------------------------------|
| Source     | [FTP Source](../../../../s/asset-source-ftp) |
| Sink       | [FTP Sink](../../../../asset-sink-ftp)       |
...
* **`Accept only known hosts`** : Activate this, if you want to enable server validation.
  ...
  You can define them [here](../../../../../../../nced/secret-management#known-hosts-1).
...
* **`User/Secret`** : Enter a `Username` and select a `Secret` from the drop-down list. If the list is empty, then you need to first [create a secret](../../../../ces/asset-resource-secret) to
  be
...
* [FTP Source](../../../../s/asset-source-ftp)
* [FTP Sink](../../../../asset-sink-ftp)
* [Stream Input Processor](../../../../sors-input/asset-input-stream)
* [Stream Output Processor](../../../../sors-output/asset-output-stream)
