...
* [Format Generic](../../../../s/asset-format-generic)
* [Format Data Dictionary](../../../../s/asset-format-data-dictionary)
* [Format ASN.1](../../../../s/asset-format-asn1)

**A Kafka Sink:**

* [Source Kafka](../../../../s/asset-source-kafka)
...
You need to assign a [Kafka Source](../../../../s/asset-source-kafka). The Source defines which topics can be read from.
