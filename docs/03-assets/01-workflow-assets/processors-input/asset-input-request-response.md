...
* [Http-Format](../../../../s/asset-format-http)
* [Http-Source](../../../../s/asset-source-http)

## Configuration

### Name & Description

](.asset-input-request-response_images/ab452d78.png)
...
Assign a [Http-Format](../../../../s/asset-format-http) which you have previously defined.
This Input-Asset will process the requests and responses which are defined in that assigned [Http-Format](../../../../s/asset-format-http).
The format will be applied on the incoming data so that it can be accessed via the data dictionary.

](.asset-input-request-response_images/4a80984c.png)

### Source

Assign a [Http-Source](../../../../s/asset-source-http).
The Source defines the physical addresses and ports on how this Input Asset can be reached.

](.asset-input-request-response_images/11611cf6.png)
