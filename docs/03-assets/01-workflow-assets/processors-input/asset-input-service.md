...
* [Service Source](/docs/assets/workflow-assets/sources/asset-source-service)
...
You need to assign a [Service Source](/docs/assets/workflow-assets/sources/asset-source-service).
