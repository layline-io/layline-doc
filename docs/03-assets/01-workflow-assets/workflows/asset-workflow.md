...
| Asset type | Link |
|---|---|
| Projects | [Project](../../../../ts-workflows/project) |
...
Configure notifications for Workflow lifecycle events. Each event type uses the [Alarm Center](../../../../../../../luster/alarm-center) to route alerts.
...
This example builds on the [TCP Source](../../../../s/asset-source-tcp) and [Stream Input Processor](../../../../sors-input/asset-input-stream) to create a complete sensor data ingestion pipeline.
...
* [Project](../../../../ts-workflows/project) — Workflows are contained within Projects
* [Stream Input Processor](../../../../sors-input/asset-input-stream) — the required entry point of every Workflow
* [Deployment](../../../../ts-workflows/deployment) — how Workflows are deployed to an engine
* [Alarm Center](../../../../../../../luster/alarm-center) — how alarming events are routed and handled
