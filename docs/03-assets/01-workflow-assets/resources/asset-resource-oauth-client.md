...
**`Secret`** — the secret value. Enable **Use a secret** to reference a value from [Secret Storage](../../../../ces/asset-resource-secret), or disable it to enter a raw secret value directly.
...
](.asset-resource-oauth-client_images/oauth-client-editor.png)
...
- [Secret](../../../../ces/asset-resource-secret) — for storing secret values in Secret Storage and referencing them in this Resource
- [Secret Management (Concept)](../../../../../../../nced/secret-management) — overview of how layline.io manages credentials
