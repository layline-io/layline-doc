...
:::tip
If you are not familiar with how AI fits into layline.io Workflows, read [Using Artificial Intelligence in Workflows](../../../../../../../nced/artificial-intelligence) first.
:::
...
](.asset-resource-ai-model_images/ai-model-j48-settings.png)
...
](.asset-resource-ai-model_images/ai-model-attributes.png)
...
](.asset-resource-ai-model_images/ai-model-mlp-settings.png)
