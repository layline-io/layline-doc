...
What's needed is very similar to how we are using variables from [Environment Assets](../../../../ces/asset-resource-environment).
There we reference Environment Variables with [macros](../../../../../../../erence/macros#lay).
It works the same way with Secrets, only the [prefix (sec)](../../../../../../../erence/macros#sec) is different.
...
For detailed information about this, please read through the [Security Storage](../../../../../../../nced/secret-management#concept-in-laylineio) documentation first, and then return here.
...
You will only see those Reactive Clusters, which have either been defined in [global cluster settings](../../../../../../../ings/settings-cluster), or within the currently opened Project
...
To learn more about how to use environment variables within layline.io settings, please read [here](../../../../../../../erence/macros#sec).
