...
](.asset-resource-status-definition_images/status-definition-editor.png)
...
- [Secret](../../../../ces/asset-resource-secret) — for storing secret values alongside status definitions
- [Environment](../../../../ces/asset-resource-environment) — for environment-specific configuration
