...
**`Directory`** — the directory path. Can be relative (resolved against the Reactive Engine base directory) or absolute. Supports [macros](../../../../../../../erence/macros) for environment-specific values.
...
**`Symbolic link`** — the path where the symlink is created. Can be relative or absolute. Supports [macros](../../../../../../../erence/macros).
...
- Both paths and permissions support [macro substitution](../../../../../../../erence/macros), enabling per-environment configuration through inheritance
...
](.asset-resource-directories_images/directories-editor.png)

</div>

## See Also

- [Secret](../../../../ces/asset-resource-secret) — for managing sensitive credentials alongside directory paths
- [Environment](../../../../ces/asset-resource-environment) — for environment-specific variable substitution
- [Macros](../../../../../../../erence/macros) — for using macros in directory paths and permission strings
