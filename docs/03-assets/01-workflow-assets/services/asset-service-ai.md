...
:::tip
If you are not familiar with the AI workflow in layline.io, read [Using Artificial Intelligence in Workflows](../../../02-concept/06-advanced/03-artificial-intelligence.md) first.
:::
