...
For this to work, you need a configured [Email Connection](../../../../tions/asset-connection-email).
...
Use the drop-down list to select a [Email Connection](../../../../tions/asset-connection-email) that should
