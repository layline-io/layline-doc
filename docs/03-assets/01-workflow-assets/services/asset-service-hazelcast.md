...
|--------------|------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|----------------------------------|--------------------------------------------------------------------------------------------------------------|
| Read         | `services.<Logical Service Name>.Read<Collection>(key)`                                                          | [Message](../../../../../../../erence/javascript/API/classes/Message) or null if nothing found   | Read data from the Collection.   | `services.MyHazelcastService.ReadCustomer(customer_id)`                                                      |
...
| Delete       | `services.<Logical Service Name>.Delete<Collection>(key)`                                                        | [Message](../../../../../../../erence/javascript/API/classes/Message) or null if nothing deleted | Delete data from the Collection. | `services.MyHazelcastService.DeleteCustomer(customer_id)`                                                    |
...
Note how the Service function returns a [Message](../../../../../../../erence/javascript/API/classes/Message) as a result
type.
