...
For a full description of the methods please refer to the [TimerService API](/docs/04-language-reference/javascript/API/classes/TimerService.md) documentation.
