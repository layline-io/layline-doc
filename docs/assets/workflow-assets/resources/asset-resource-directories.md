...
**`Directory`** — the directory path. Can be relative (resolved against the Reactive Engine base directory) or absolute. Supports [macros](../../../language-reference/macros.md) for environment-specific values.
...
**`Symbolic link`** — the path where the symlink is created. Can be relative or absolute. Supports [macros](../../../language-reference/macros.md).
...
- Both paths and permissions support [macro substitution](../../../language-reference/macros.md), enabling per-environment configuration through inheritance
...
- [Macros](../../../language-reference/macros.md) — for using macros in directory paths and permission strings
