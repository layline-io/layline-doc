...
:::tip
If you are not familiar with how AI fits into layline.io Workflows, read [Using Artificial Intelligence in Workflows](../../../concept/advanced/artificial-intelligence.md) first.
:::
...
![Attributes — class attribute and input attribute table](.asset-resource-ai-model_images/ai-model-jsettings.png)
