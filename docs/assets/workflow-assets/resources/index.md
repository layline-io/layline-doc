...
- [**Connections**](/docs/assets/workflow-assets/connections/asset-connection-aws) — Reusable connection parameters for external systems (often reference Secrets and Environment variables)
...
- [**Macros**](/docs/language-reference/macros.md) — Syntax for referencing Resource values in asset configurations
