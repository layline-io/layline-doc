...
- [**VFS Connection**](/docs/assets/workflow-assets/connections/asset-connection-virtual-fs.md) — VFS connection configuration
- [**SMB Sink**](../sinks/asset-sink-smb.md) — Write files to SMB/CIFS shares
