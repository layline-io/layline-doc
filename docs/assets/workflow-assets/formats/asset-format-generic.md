...
![Name & Description (Format ASN.1)](.asset-format-generic_images/575d9316.png)
...
![](.asset-format-generic_images/fa5d21d1.png "Format Definition (Format Generic)")
...
Please check the [QuickScript Language Reference](../../../language-reference/quickscript/quickscript.md) for more info.
...
![](.asset-format-generic_images/a625269c.png "Sample File View (Format Generic)")
...
![](.asset-format-generic_images/ef908314.png "Sample Message View (Format Generic)")
...
![](.asset-format-generic_images/c8f79c84.png "In case of error (Format Generic)")
