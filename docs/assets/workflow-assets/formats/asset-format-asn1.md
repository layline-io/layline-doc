...
![Configuratoin and Modules Tab (Format ASN.1)](.asset-format-generic_images/bbd2a7a6.png)
...
You can obtain the complete TAP3 specification [here](https://www.gsma.com/aboutus/workinggroups/wp-content/uploads/2015/01/tapdocs1.zip).
:::
...
![Name & Description (Format ASN.1)](.asset-format-asn1_images/6e5cda26.png)
...
![Modules Tab (Formata ASN.1)](.asset-format-asn1_images/5792e17b.png)
...
![Add ASN.1 module (Format ASN.1)](.asset-format-asn1_images/53656035.png)
...
![ASN.1 module configuration (Format ASN.1)](.asset-format-asn1_images/aa822330.png)
...
* **`Data Dictionary Namespace`** (optional):
  ...
  See also [createMessage](../../../language-reference/javascript/API/classes/DataDictionary.md#createmessage).
...
* **`ASN.1 module`**:
  ...
  ![ASN.1 module (Format ASN.1)](.asset-format-asn1_images/8d9cea11.png)
...
![](.asset-format-asn1_images/d70ad41b.png)
...
![Message Creation  (Format ASN.1)](.asset-format-asn1_images/ad6df218.png)
...
* **Message mapping**:
  ...
  ![Add Message Creation Data (Format ASN.1)](.asset-format-asn1_images/32bd48a5.png)
  ...
  ![Enterin ASN.1 Contect (Format ASN.1)](.asset-format-asn1_images/5f03deaa.png)
  ...
  ![ASN.1 Context (Format ASN.1)](.asset-format-asn1_images/1dc27d41.png)
...
![Modules Tab (Format ASN.1)](.asset-format-asn1_images/337d90e7.png)
...
![Sample File Viewer load file (Format ASN.1)](.asset-format-asn1_images/f5d21bfa.png)
...
![Sample File Viewer with loaded file (Format ASN.1)](.asset-format-asn1_images/cfd1ba06.png)
...
![Sample File Viewer hex output (Format ASN.1)](.asset-format-asn1_images/a042463c.png)
...
![Sample File Viewer Sample Messages Tab (Format ASN.1)](.asset-format-asn1_images/d285b558.png)
...
![Sample File Viewer Parsed Values](.asset-format-asn1_images/011bac28.png)
