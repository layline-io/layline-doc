...
-> [Data Dictionary Concept](../../../concept/data-dictionary.md)
:::

## What is the purpose of the Data Dictionary Asset?

As explained in the [Data Dictionary Concept](../../../concept/data-dictionary.md), layline.io creates a global internal Data Dictionary based on all the data formats defined by you.
...
![Name & Description (Format Data Dictionary)](.asset-format-data-dictionary_images/40b921f2.png)
...
![Format dependencies (Format Data Dictionary)](.asset-format-data-dictionary_images/2debae71.png)
...
![Missing format dependency](.asset-format-data-dictionary_images/b6aa3038.png)
...
![Format types (Format Data Dictionary)](.asset-format-data-dictionary_images/da98aee2.png)
...
![Data Dictionary Example (Format Data Dictionary)](.asset-format-data-dictionary_images/7b85f606.png)
...
![Declare Root Type (Format Data Dictionary)](.asset-format-data-dictionary_images/22d42e10.png)

A new element `Namespace1` will be created. Click on it to select it.

![New root Element (Format Data Dictionary)](.asset-format-data-dictionary_images/c1c8e3d7.png)
...
![PowerEnum Configuration (Format Data Dictionary)](.asset-format-data-dictionary_images/480fb315.png)
...
![PowerEnum Declare Element (Format Data Dictionary)](.asset-format-data-dictionary_images/0f674855.png)

and define the following elements:

![PowerEnum Element Declaration](.asset-format-data-dictionary_images/7e60b638.png)
...
![EngineType Declaration (Format Data Dictionary)](.asset-format-data-dictionary_images/d9cb62f6.png)
...
![Vehicle Type add Child (Format Data Dictionary)](.asset-format-data-dictionary_images/473f0e6e.png)

Then add the `Boat` element:

![Boat Element Declaration (Format Data Dictionary)](.asset-format-data-dictionary_images/4ea5db37.png)
...
![Car Element Declaration (Format Data Dictionary)](.asset-format-data-dictionary_images/da294ebc.png)
...
![Namespace Declaration (Format Data Dictionary)](.asset-format-data-dictionary_images/04be6b3e.png)
...
![Array Declaration (Array Data Dictionary)](.asset-format-data-dictionary_images/1e4b0161.png)
...
![Choice Declaration (Array Data Dictionary)](.asset-format-data-dictionary_images/f649ef9e.png)
...
![Enumeration Declaration (Array Data Dictionary)](.asset-format-data-dictionary_images/732e9977.png)
...
![Sequence Declaration (Array Data Dictionary)](.asset-format-data-dictionary_images/98be4609.png)
...
![Data Dictionary Record Namespace (Format Data Dictionary)](.asset-format-data-dictionary_images/80b1043f.png)
...
![Encoding: Select encoding type (Format Data Dictionary)](.asset-format-data-dictionary_images/66568fa2.png)
...
![Encoding: Add type selectors (Format Data Dictionary)](.asset-format-data-dictionary_images/7ded88e8.png)

Next, we add the conditions for when these should be selected, based on the incoming information:

![Encoding: Setting selector conditions (Format Data Dictionary)](.asset-format-data-dictionary_images/771363a7.png)
...
![Encoding: Adding multiple selector conditions (Format Data Dictionary)](.asset-format-data-dictionary_images/d8418308.png)
...
![Linking Format to Input Processor (Format Data Dictionary)](.asset-format-data-dictionary_images/1f2abef2.png)
...
To understand how to work with the Data Dictionary in Javascript, [check here](../../../language-reference/javascript/index.md).
:::
