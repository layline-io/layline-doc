...
![Name & Description (Format Http)](.asset-format-http_images/1140f0fa.png)
...
![Data Dictionary Namespace (Http Format Asset)](.asset-format-http_images/cc6801b8.png)
...
![Add new path (Http Format Asset)](.asset-format-http_images/a9ce2f59.png)

A new path will be created with some default parameters.

![Path name and http path (Http Format Asset)](.asset-format-http_images/89f9f7e9.png)
