...
|--------------|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|----------------------------|--------------------------------------------------------------------------------------------------|
| Read         | `services.<Logical Service Name>.Read<BinName>(key: String)`                                  | [Message](../../../language-reference/javascript/API/classes/Message.md) or null of nothing found   | Read data from Aerospike   | `services.CustomerData.ReadCustomerData({Key: "017212345678"})`                                  |
...
| Delete       | `services.<Logical Service Name>.Delete<BinName>(key: String)`                                | [Message](../../../language-reference/javascript/API/classes/Message.md) or null if nothing deleted | Delete data from Aerospike | `services.CustomerData.DeleteCustomerData({Key: "017212345678"})`                                |
