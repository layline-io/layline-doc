...
![DynamoDB Service Settings](./.asset-service-dynamo-db_images/settings.png)
...
![DynamoDB Functions Card](./.asset-service-dynamo-db_images/functions-card.png)
...
![DynamoDB Collections Card](./.asset-service-dynamo-db_images/collection-card.png)
...
![DynamoDB Attribute Mapping](./.asset-service-dynamo-db_images/attribute-mapping.png)
