...
|--------------|------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|----------------------------------|--------------------------------------------------------------------------------------------------------------|
| Read         | `services.<Logical Service Name>.Read<Collection>(key)`                                                          | [Message](../../../language-reference/javascript/API/classes/Message.md) or null if nothing found   | Read data from the Collection.   | `services.MyHazelcastService.ReadCustomer(customer_id)`                                                      |
...
| Delete       | `services.<Logical Service Name>.Delete<Collection>(key)`                                                        | [Message](../../../language-reference/javascript/API/classes/Message.md) or null if nothing deleted | Delete data from the Collection. | `services.MyHazelcastService.DeleteCustomer(customer_id)`                                                    |
