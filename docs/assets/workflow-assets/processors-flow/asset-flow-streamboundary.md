...
As you can see from the example above, you can use [Macros](../../../language-reference/macros.md) here.
...
|----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---|
| **Start Downstream**                   | Start a new stream. The original message is **NOT** forwarded.                                                                                                                              | - `Stream Name`: Name of the newly created stream.<br/>You can use [Macros](../../../language-reference/macros.md) here.<br/>Example: `${msg:Header.Name}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |   |
