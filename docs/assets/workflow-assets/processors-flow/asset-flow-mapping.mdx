...
To perform mapping you should have a solid understanding of **[layline.io's Data Dictionary concept](../../../concept/data-dictionary.md)**.
:::
...
As the little "_qs_" icon to the right implies, and is shown in the example, you can use [Quickscript](../../../language-reference/quickscript/quickscript.md) here.
