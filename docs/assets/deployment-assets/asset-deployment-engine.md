...
For details on how Environment Assets work, see [Environment Asset](../workflow-assets/resources/asset-resource-environment.md).
...
For details on how Secret Assets work, see [Secret Asset](../workflow-assets/resources/asset-resource-secret.md).
...
- [**Environment**](../workflow-assets/resources/asset-resource-environment.md) — Store configuration values for different deployment targets
- [**Secret**](../workflow-assets/resources/asset-resource-secret.md) — Manage sensitive data for workflows
