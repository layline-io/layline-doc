...
class Message {
     ...
     * ```
     *
     * @param {EntityDeclaration} entityDeclaration - The Path to data dictionary structure which you want to test for existence in the message ({@link EntityDeclaration}.)
