...
• **vendor**: [`VendorInfo`](VendorInfo.md)

Status messages can be distinguished by vendor. Pass a [VendorInfo](VendorInfo.md) here. Obtain it with [Status.getVendorByName](Status.md#getvendorbyname)
